                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="width: 100%; max-width: 640px; background: #ffffff; border: 1px solid #d8dce0; border-radius: 22px; overflow: hidden; box-shadow: 0 16px 38px rgba(18, 22, 28, 0.08);">
                    <tr>
                        <td style="padding: 28px 32px 18px; text-align: center; border-bottom: 1px solid #eceff2;">
                            <img src="${escapeHtml(siteUrl)}/public/kavologo.png" alt="Kavo Technologies UK" width="164" style="display: inline-block; max-width: 164px; width: 100%; height: auto;">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="padding: 0 32px 30px; text-align: center; font-size: 12px; line-height: 20px; color: #8a919b;">
                            Kavo Technologies UK, London, United Kingdom<br>
...
function buildUserEmail(data, siteUrl) {
    return buildEmailShell({
        ...
        intro: `Thanks for reaching out, ${data.name}. We have received your enquiry and a member of the Kavo Technologies UK team will review it shortly.`,
        detailRows: [
        ...
        ctaLabel: 'Visit Kavo Technologies UK',
        ctaHref: siteUrl,
        footerNote: 'This is a confirmation copy of the message you submitted to Kavo Technologies UK.',
        siteUrl
    });
}
...
function buildAdminEmail(data, siteUrl) {
    return buildEmailShell({
        ...
        intro: 'A new contact form submission has arrived from the Kavo Technologies UK website. Review the lead details below and follow up promptly.',
        detailRows: [
            { label: 'Name', value: data.name },
            { label: 'Email', value: data.email },
            { label: 'Phone', value: data.phone || 'Not provided' },
        ...
        footerNote: 'This message was generated by the Kavo Technologies UK contact form.',
        siteUrl
    });
}
...
async function sendContactEmails(submission) {
    ...
    const [userResult, adminResult] = await Promise.all([
        resend.emails.send({
            from: `Kavo Technologies UK <${fromEmail}>`,
            to: submission.email,
            ...
            text: [
                `Hi ${submission.name},`,
                '',
                'Thanks for contacting Kavo Technologies UK. We have received your message and will be in touch shortly.',
                '',
        ...
        resend.emails.send({
            ...
            html: adminEmailHtml,
            text: [
                'New lead from the Kavo Technologies UK contact form.',
                '',
                `Name: ${submission.name}`,
                `Email: ${submission.email}`,
                `Phone: ${submission.phone || 'Not provided'}`,
